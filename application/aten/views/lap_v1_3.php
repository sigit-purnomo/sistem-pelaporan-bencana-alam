            ...
            if(count($detail) > 0) 
            {
              foreach($detail as $rows) 
              {
                ...
                echo "
                  ...
                  <div class='indent2'>
                  <p>a. Tim Reaksi Cepat dengan jumlah ". $jumlah_tim ." orang, terdiri dari  ". $tim_bpbd ." orang dari BPBD, ". $tim_dinsos." orang 
                  dari dinos, ". $tim_dinkes ." orang dari dinkes, ". $tim_pu ." orang dari PU, dan seterusnya telah tiba di 
