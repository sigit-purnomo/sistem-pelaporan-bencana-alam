                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <?php echo form_open("petugas_control/edit_petugas/".$id_user); ?>
                                    <div class="form-group">
                                        <label for="nama">Nama Lengkap: </label>
                                        <label for="nama" style="color:red;"><?php echo form_error('nama', '* <span class="error">', '</span>'); ?></label>
                                        <input class="form-control" id="nama" name="nama" placeholder="Nama Lengkap" value="<?php echo $nama_lengkap; ?>"/>
                                    </div>

                                    <div class="form-group">
                                        <label for="username">Username: </label>
                                        <label for="username" style="color:red;"><?php echo form_error('username', '* <span class="error">', '</span>'); ?></label>
                                        <input class="form-control" id="username" name="username" placeholder="Username" value="<?php echo $username; ?>"/>
                                    </div>

                                    <div class="form-group">
                                       <label for="password">Password: </label>
                                        <label for="password" style="color:blue;">*masukan password baru</label>
                                        <br><input type="checkbox" onchange="document.getElementById('password').type = this.checked ? 'text' : 'password'">Tampilkan password</input>
                                    ...
                                    <div class="form-group input-group">
                                        ...
                                        <input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon" placeholder="Nomor Telepon" value="<?php echo substr($no_hp,'3'); ?>">
                                    </div>
