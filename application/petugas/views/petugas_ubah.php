...
<head>
    ...
    <title>Pengelolaan Petugas - Ubah Data</title>
    <!-- BOOTSTRAP STYLES-->
...
font-size: 16px;"> Selamat Datang <?php echo $username; ?> &nbsp; <a href="<?php echo site_url('login_control/logout');?>" class="btn btn-danger square-btn-adjust">Keluar</a> </div>
                ...
                <li class="text-center">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-sub-menu" href="<?php echo site_url('petugas_control/view_ubah_petugas');?>">Ubah Data</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Pengelolaan Petugas - Ubah Data</h2>   
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <!-- <form role="form"> -->
                                    <?php foreach ($info_petugas as $rows ) 
                                    {   
                                    ?> 
                                        <?php echo form_open("petugas_control/edit_petugas/".$rows->id_user); ?>
                                        <div class="form-group">
                                            <label for="nama">Nama Lengkap: </label>
                                            <label for="nama" style="color:red;"><?php echo form_error('nama', '* <span class="error">', '</span>'); ?></label>
                                            <input class="form-control" id="nama" name="nama" placeholder="Nama Lengkap" value="<?php echo $rows->nama_lengkap; ?>"/>
                                        </div>

                                        <div class="form-group">
                                            <label for="username">Username: </label>
                                            <label for="username" style="color:red;"><?php echo form_error('username', '* <span class="error">', '</span>'); ?></label>
                                            <input class="form-control" id="username" name="username" placeholder="Username" value="<?php echo $rows->username; ?>"/>
                                        </div>

                                        <div class="form-group">
                                            <label for="password">Password: </label>
                                            <label for="password" style="color:blue;">*masukan password baru</label>
                                            <br><input type="checkbox" onchange="document.getElementById('password').type = this.checked ? 'text' : 'password'">Tampil password</input>
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon" placeholder="Nomor Telepon" value="<?php echo substr($rows->no_hp,'3'); ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="role">Role Petugas : </label>
                                            <?php if($rows->id_role == 1)
                                            { ?>
                                        ...
                                        <input type="submit" class="btn btn-default" onclick="return checkEdit()" value="Simpan Data"/>
