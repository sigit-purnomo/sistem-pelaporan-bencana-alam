...
<?php echo form_open('admin/c_petugas/simpan_petugas'); ?>
...
<fieldset>
    ...
    <label  class="col-md-2 control-label" for="nama">Nama Petugas</label>
    <div class="col-md-10">
 ...
 <div class="col-md-10">
    ...
    <p>
      ...
      <input type="button" value="Batal" id="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>admin/c_petugas'"/>
			</p>	
			</div>
		</div>
	</div>
